...
namespace DormitoryMystery.Chapter1
{
    ...
    public sealed class Mission01AudioSeparatorManager : MonoBehaviour
    {
        ...
        public void NotifyAllLanAudioStemsSaved()
        {
            ...
            {
                Debug.LogWarning("[Mission01AudioSeparatorManager] Cannot finish audio separator until all 6 audio stems are saved to the phone.", this);
                return;
            }

            bool firstCompletion = !data.Mission01LanRecordingSeparated;
            data.Mission01LanRecordingSeparated = true;
            data.Mission01AudioSeparatorMixerCompleted = true;

            // Saving all six stems is the completion condition for Task 1.
            // Listening to them in the phone remains optional; the next
            // required step is returning to Minh for the Task 2 briefing.
